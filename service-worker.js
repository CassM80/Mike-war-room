const CACHE='war-room-sprint-25-0';
const ASSETS=["./","./index.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./css/styles.css","./data/players.js","./js/playerData.js","./js/storage.js","./js/draftEngine.js","./js/recommendationEngine.js",
  "./js/marketCoverage.js","./js/marketSync.js","./js/auctionEngine.js","./js/blueprint.js","./js/myGuys.js","./js/ui.js","./js/app.js"];
