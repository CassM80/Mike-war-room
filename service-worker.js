const CACHE='war-room-sprint-25-3-1';
const ASSETS=["./","./index.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./css/styles.css","./data/players.js",
  ...
  "./js/marketCoverage.js","./js/marketSync.js","./js/auctionEngine.js","./js/blueprint.js","./js/myGuys.js","./js/ui.js","./js/mobileWarRoom.js","./js/app.js"];
